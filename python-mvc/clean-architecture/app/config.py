"""
Configuration module for the Clean Architecture application.

Reads database and application settings from environment variables.
This module belongs to the outermost (frameworks) layer.
"""
...
class Settings:
    ...
    db_port: int = int(os.environ.get("DB_PORT", "5435"))
    db_user: str = os.environ.get("DB_USER", "postgres")
    db_password: str = os.environ.get("DB_PASSWORD", "postgres")
    db_name: str = os.environ.get("DB_NAME", "clean_db")
