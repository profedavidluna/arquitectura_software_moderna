"""
Configuration module for the Hexagonal Architecture application.

Reads database and application settings from environment variables.
This module belongs to the infrastructure/framework layer.
"""
...
class Settings:
    ...
    db_name: str = os.environ.get("DB_NAME", "hexagonal_db")
