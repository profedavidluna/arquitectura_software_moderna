 ...
 * @description PostgreSQL implementation of the ProductGateway interface.
 * In Clean Architecture, this is the outermost layer that implements
 * interfaces defined by the inner layers.
 *
 * Uses the `pg` library with connection pooling for efficient
 * database access. Implements the same contract as InMemoryProductGateway.
 *
