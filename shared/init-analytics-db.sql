...
-- This script is executed when the analytics-db container starts
...
CREATE INDEX IF NOT EXISTS idx_product_performance_date ON product_performance(metric_date);
CREATE INDEX IF NOT EXISTS idx_user_behavior_user_id ON user_behavior(user_id);
CREATE INDEX IF NOT EXISTS idx_user_behavior_date ON user_behavior(metric_date);
CREATE INDEX IF NOT EXISTS idx_cohort_analysis_date ON cohort_analysis(cohort_date);
